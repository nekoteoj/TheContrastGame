...
public class FloorBox extends RenderableMapObject {
	...
	static {
		image = new Image(ClassResourceUtility.getResourcePath("img/model/map/FloorBox/1.png"), BOXWIDTH, BOXHEIGHT, true, true);
	}
	
	private int amount;
	
	public FloorBox(int x, int y, int amount) {
