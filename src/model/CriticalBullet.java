...
public class CriticalBullet extends Bullet {
	...
	static {
		...
		imageFrame.add(new Image(ClassResourceUtility.getResourcePath("img/model/CriticalBullet/1R.png"), 42, 10, true, true));
		imageFrame.add(new Image(ClassResourceUtility.getResourcePath("img/model/CriticalBullet/1L.png"), 42, 10, true, true));
