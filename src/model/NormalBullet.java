...
public class NormalBullet extends Bullet {
	...
	static {
		...
		imageFrame.add(
				new Image(ClassResourceUtility.getResourcePath("img/model/NormalBullet/1R.png"), 20, 6, true, true));
		imageFrame.add(
				new Image(ClassResourceUtility.getResourcePath("img/model/NormalBullet/1L.png"), 20, 6, true, true));
