...
public class TankBullet extends Bullet {
	...
	static {
		...
		imageFrameLeft.add(new Image(ClassResourceUtility.getResourcePath("img/model/TankBullet/1L.png"), BULLETWIDTH,
				BULLETHEIGHT, true, true));
		imageFrameLeft.add(new Image(ClassResourceUtility.getResourcePath("img/model/TankBullet/2L.png"), BULLETWIDTH,
				BULLETHEIGHT, true, true));
		imageFrameRight = new ArrayList<>();
		imageFrameRight.add(new Image(ClassResourceUtility.getResourcePath("img/model/TankBullet/1R.png"), BULLETWIDTH,
				BULLETHEIGHT, true, true));
		imageFrameRight.add(new Image(ClassResourceUtility.getResourcePath("img/model/TankBullet/2R.png"), BULLETWIDTH,
				BULLETHEIGHT, true, true));
