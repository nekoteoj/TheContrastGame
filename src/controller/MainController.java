...
public class MainController {
	...
	public MainController() {
		...
		mainMenuCanvasController = new MainMenuCanvasController(
				((MainMenuPane) viewManager.getPane("menu")).getMainMenuCanvas(),
				((MainMenuPane) viewManager.getPane("menu")).getMenu());
	}
